/**
 * Neuer Chat – Schritt 1: Teilnehmer auswaehlen (Einzelchat oder Mehrpersonen).
 *
 * Referenz-Design:
 * - Header: umrandeter Zurück-Button + „Neuer Chat" + „Weiter" (blau)
...
export default function NewChatSelectScreen() {
